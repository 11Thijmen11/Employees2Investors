...
import ProfilePhoto from '../assets/FOTO TRANSPARANT DION E2I.png'
...
export default function About() {
  return (
    <div className="space-y-16 pb-8">
      ...
      {/* Wie ben ik & Mijn Missie Side by Side */}
      <motion.section
        initial="hidden"
        whileInView="visible"
        viewport={{ once: true, margin: "-50px" }}
      ...
      >
        <div className="grid md:grid-cols-2 gap-6">
          {/* Wie ben ik blok */}
          <motion.div variants={fadeUp}>
            <div className="card bg-white p-8 md:p-12 rounded-3xl border-4 border-primary h-full">
              <h2 className="text-3xl font-bold text-primaryDark mb-4 flex items-center gap-3">
      ...
      <motion.section
        ...
        className="container mx-auto px-4"
      >
        <motion.h2 variants={fadeUp} className="text-3xl md:text-4xl font-bold text-black mb-12 text-center">
          Mijn waarden
        </motion.h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              key={idx}
              variants={fadeUp}
              className="card p-6 md:p-8 text-center hover:shadow-xl transition-shadow border-t-4 border-primary"
            >
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {[
            ...
            <motion.div
              key={idx}
              variants={fadeUp}
              className="card p-6 flex items-start gap-4 hover:shadow-lg transition-shadow border-l-4 border-primary"
            >
      ...
      <motion.section
        ...
        viewport={{ once: true, margin: "-50px" }}
        variants={{ visible: { transition: { staggerChildren: 0.1 } } }}
        className="container mx-auto px-4 py-12 bg-white rounded-3xl text-center border-4 border-primary"
      >
